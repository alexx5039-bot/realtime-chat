...
from chat.routes.dependencies import get_current_user, get_user_repo
from chat.schemas.user import (
    LoginResponse,
    RefreshRequest,
    UserCreate,
    UserResponse,
...
async def register(
    ...
    user = await user_repo.create(email=user_data.email, password_hash=password_hash)
    return user
